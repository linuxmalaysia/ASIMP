...
* **AI Playbook Validation Ladder & Red Hat CoP Standard Adoption (August 2026)**: Formalized `Rule 32.43` (Automated Ansible Playbook Validation Ladder & Idempotence Assertion) and `Rule 32.44` (Ansible Community AI-Forge & Red Hat CoP Automation Good Practices) across governance files and added the `dsom-infrastructure-playbook-documenter` skill.
